...
struct EquipEditView: View {
    ...
    private func positionView1(_ position: EquipPosition, selected: Binding<Equip?>) -> some View {
        EquipSelectPositionView(kungfu: kungfu, position: position, selectedEquip: selected)
    }
    
    private func positionBinding(_ position: EquipPosition) -> Binding<Equip?> {
        return Binding(get: {
